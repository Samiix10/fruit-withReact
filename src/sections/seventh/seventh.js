import "./seventh.css";
import SeventhBox from "./seventhComponants/seventhComp";
import seventhData from "./seventhComponants/Seventhdata";
    ...
    <>
      <div className="seventh ">
        <div className="container-xxl">
          <div className="SenemthHeading text-center">
            <h2>Our Blogs & News</h2>
          </div>
          <div className="SeventhContent">
            <div className="row">
              <SeventhBox data={seventhData}></SeventhBox>
            </div>
          </div>
        </div>
